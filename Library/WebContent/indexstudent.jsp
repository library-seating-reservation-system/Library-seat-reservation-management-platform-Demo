...
<div id="topmenu" class="l-topmenu">
    ...
    <div class="l-topmenu-admin">
        	<p class="l-link2"><strong title="2 unread messages" style="cursor: pointer;">Classmate</strong>,Welcome!</p>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
        <div position="left"  title="Main menu" id="accordion1">
                    <div title="Reservation" >
                        <a class="l-link" href="javascript:f_addTab('SeatReservation','Reservation of spare seats','Reservation/SeatReservation.jsp')">Reservation of spare seats</a>
						<a class="l-link" href="javascript:f_addTab('MySeat','My seat','Reservation/MySeat.jsp')">My seat</a>
                    </div>
                    <div title="Repair">
                        <a class="l-link" href="javascript:f_addTab('Repairstu','Situation statement','Repair/Repairstu.jsp')">Situation statement</a>
						   <a class="l-link" href="javascript:f_addTab('Repaircontact','Contact property','Repair/Repaircontact.jsp')">Contact property</a>
                    </div>
        </div>
