    ...
    var CustomersData =null;
        ...
        function f_initGrid()
        {
            ...
            g = manager = $("#maingrid").ligerGrid({
                ...
                { display: 'Operating', isSort: false, width: 120, render: function (rowdata, rowindex, value)
                {
                    var h = "";
                    
                        h += "<a href='javascript:endEdit(" + rowindex + ")'>Yes</a> ";
                        h += "<a href='javascript:deleteRow(" + rowindex + ")'>No</a> "; 
                    return h;
                }
                }
                ],
